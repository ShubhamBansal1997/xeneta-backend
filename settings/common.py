"""Django settings for xeneta project.
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "xeneta.base.api.pagination.LimitOffsetPagination",
    "PAGE_SIZE": 30,
    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "xeneta.base.renderers.XenetaApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "xeneta.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": "rest_framework.schemas.coreapi.AutoSchema",
    "EXCEPTION_HANDLER": "xeneta.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="xeneta")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="xeneta")
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="xeneta <support@xeneta.com>")
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[xeneta] ")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///xeneta")}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "xeneta.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "xeneta.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "xeneta": {"handlers": ["console"], "level": "INFO", "propagate": False},
